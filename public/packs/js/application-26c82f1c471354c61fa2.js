...
/* harmony import */ var bootstrap_js_src_scrollspy__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! bootstrap/js/src/scrollspy */ "./node_modules/bootstrap/js/src/scrollspy.js");
  ...
  _createClass(Collapse, [{
    ...
    value: function show() {
      ...
      if (this._config.parent) {
        var children = _dom_selector_engine__WEBPACK_IMPORTED_MODULE_4__["default"].find(CLASS_NAME_DEEPER_CHILDREN, this._config.parent);
    ...
    value: function _getConfig(config) {
      ...
      config.parent = Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["getElement"])(config.parent);
...
Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["defineJQueryPlugin"])(Collapse);
...
var SelectorEngine = {
  ...
  focusableChildren: function focusableChildren(element) {
    ...
    return this.find(focusables, element).filter(function (el) {
      return !Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["isDisabled"])(el) && Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["isVisible"])(el);
    });
  }
};
...
var PLACEMENT_TOP = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'top-end' : 'top-start';
var PLACEMENT_TOPEND = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'top-start' : 'top-end';
var PLACEMENT_BOTTOM = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'bottom-end' : 'bottom-start';
var PLACEMENT_BOTTOMEND = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'bottom-start' : 'bottom-end';
var PLACEMENT_RIGHT = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'left-start' : 'right-start';
var PLACEMENT_LEFT = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? 'right-start' : 'left-start';
var Default = {
  offset: [0, 2],
...
var Dropdown = /*#__PURE__*/function (_BaseComponent) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function show() {
      ...
      if ('ontouchstart' in document.documentElement && !parent.closest(SELECTOR_NAVBAR_NAV)) {
        ...
        (_ref = []).concat.apply(_ref, _toConsumableArray(document.body.children)).forEach(function (elem) {
          return _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__["default"].on(elem, 'mouseover', _util_index__WEBPACK_IMPORTED_MODULE_1__["noop"]);
        });
      }
    ...
    value: function _completeHide(relatedTarget) {
      ...
      if ('ontouchstart' in document.documentElement) {
        ...
        (_ref2 = []).concat.apply(_ref2, _toConsumableArray(document.body.children)).forEach(function (elem) {
          return _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__["default"].off(elem, 'mouseover', _util_index__WEBPACK_IMPORTED_MODULE_1__["noop"]);
        });
      }
    ...
    value: function _selectMenuItem(_ref3) {
      var key = _ref3.key,
          target = _ref3.target;
      var items = _dom_selector_engine__WEBPACK_IMPORTED_MODULE_4__["default"].find(SELECTOR_VISIBLE_ITEMS, this._menu).filter(_util_index__WEBPACK_IMPORTED_MODULE_1__["isVisible"]);
    ...
    value: function dataApiKeydownHandler(event) {
      ...
      var getToggleButton = this.matches(SELECTOR_DATA_TOGGLE) ? this : _dom_selector_engine__WEBPACK_IMPORTED_MODULE_4__["default"].prev(this, SELECTOR_DATA_TOGGLE)[0];
...
var ScrollSpy = /*#__PURE__*/function (_BaseComponent) {
  ...
  function ScrollSpy(element, config) {
    ...
    _dom_event_handler__WEBPACK_IMPORTED_MODULE_1__["default"].on(_this._scrollElement, EVENT_SCROLL, function () {
  ...
  _createClass(ScrollSpy, [{
    ...
    function refresh() {
      ...
      var targets = _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].find(SELECTOR_LINK_ITEMS, this._config.target);
      targets.map(function (element) {
        var targetSelector = Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["getSelectorFromElement"])(element);
        var target = targetSelector ? _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].findOne(targetSelector) : null;
    ...
    key: "_getConfig",
    value: function _getConfig(config) {
      config = _objectSpread(_objectSpread(_objectSpread({}, Default), _dom_manipulator__WEBPACK_IMPORTED_MODULE_2__["default"].getDataAttributes(this._element)), _typeof(config) === 'object' && config ? config : {});
      config.target = Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["getElement"])(config.target) || document.documentElement;
      Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["typeCheckConfig"])(NAME, config, DefaultType);
      return config;
    }
  }, {
    ...
    value: function _activate(target) {
      ...
      var link = _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].findOne(queries.join(','), this._config.target);
      link.classList.add(CLASS_NAME_ACTIVE);

      if (link.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
        _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].findOne(SELECTOR_DROPDOWN_TOGGLE, link.closest(SELECTOR_DROPDOWN)).classList.add(CLASS_NAME_ACTIVE);
      } else {
        _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].parents(link, SELECTOR_NAV_LIST_GROUP).forEach(function (listGroup) {
          // Set triggered links parents as active
          // With both <ul> and <nav> markup a parent is the previous sibling of any nav ancestor
          _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].prev(listGroup, "".concat(SELECTOR_NAV_LINKS, ", ").concat(SELECTOR_LIST_ITEMS)).forEach(function (item) {
            return item.classList.add(CLASS_NAME_ACTIVE);
          }); // Handle special case when .nav-link is inside .nav-item

          _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].prev(listGroup, SELECTOR_NAV_ITEMS).forEach(function (navItem) {
            _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].children(navItem, SELECTOR_NAV_LINKS).forEach(function (item) {
              return item.classList.add(CLASS_NAME_ACTIVE);
            });
          });
        });
    ...
    value: function _clear() {
      _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].find(SELECTOR_LINK_ITEMS, this._config.target).filter(function (node) {
...
_dom_event_handler__WEBPACK_IMPORTED_MODULE_1__["default"].on(window, EVENT_LOAD_DATA_API, function () {
  _dom_selector_engine__WEBPACK_IMPORTED_MODULE_3__["default"].find(SELECTOR_DATA_SPY).forEach(function (spy) {
...
Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["defineJQueryPlugin"])(ScrollSpy);
...
throw new Error("Module build failed (from ./node_modules/sass-loader/dist/cjs.js):\nSassError: Undefined variable.\n   ╷\n22 │     color: $dark-1 !important;\n   │            ^^^^^^^\n   ╵\n  app/frontend/packs/application.scss 22:12  root stylesheet");
...
__webpack_require__(/*! /home/chris/web/personal/app/frontend/packs/application.js */"./app/frontend/packs/application.js");
module.exports = __webpack_require__(/*! /home/chris/web/personal/app/frontend/packs/application.scss */"./app/frontend/packs/application.scss");


/***/ })

/******/ });
//# sourceMappingURL=application-26c82f1c471354c61fa2.js.map